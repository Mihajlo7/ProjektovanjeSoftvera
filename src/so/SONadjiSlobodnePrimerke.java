 ...
 * @author Mihajlo
 */
public class SONadjiSlobodnePrimerke extends OpstaSistemskaOperacija {
  private List<Knjiga> primerci;
   private HashMap<String,String> kriterijum;

    public SONadjiSlobodnePrimerke() {
    ...
    public void izvrsiKonkretnuOperaciju() throws ServerskiException {
        List<OpstiDomenskiObjekat> lista=broker.nadjiSlobodnePrimerke(kriterijum);
